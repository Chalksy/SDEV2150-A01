...
class ResourceResults extends HTMLElement {
  ...
  set filters(filters) {
    ...
    // If we got partial updates -- let's say some totally new component, for different reasons, only toggled openNow --
    // then we'd want to retain all existing values unless explicitly overriden, and it'd look like:
    //    this.#filters = {
    //      ...this.#filters,  // unpack existing values,
    //      ...filters,        // then override with any new values provided.
    //    };
